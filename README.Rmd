...
There are minor differences, however, when all missing values are imported from SPSS. For example,
if all missing values are treated equaliy, certain groups might appear `NA`, as seen in this example:
